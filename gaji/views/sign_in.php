...
<html lang="en">
  ...
  <body>
		      ...
		      <form class="form-login" id="login-form" method="POST" action="">
		        ...
		        <div class="login-wrap">			  
                  ...
                  <div id="alert-msg" class="alert alert-danger" style="display:none;">
		            ...
		            <input type="text" class="form-control" name="username" placeholder="User Name" autofocus autocomplete="off">
		            <br>
		              ...
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      ...
		                      <div class="modal-body">
		                          <p>Masukkan alamat e-mail anda dibawah ini untuk mereset password anda.</p>
	...
	<!-- app js -->
	<script src="<?=base_url();?>assets/js/app/sign_in.js"></script>
